    ...
    <div className="w-full max-w-[1080px] border rounded-[24px] mt-8 p-[40px] drop-shadow-[rgba(47, 115, 242, 0.15) mt-3 flex flex-col gap-[24px] bg-white">
      ...
      <div className='flex justify-between items-center gap-2'>
        <div className=' flex flex-col gap-[8px]  justify-center items-center '>
          <div className='bg-customBtn2Color rounded-full  h-[50px] w-[50px] flex justify-center items-center'>
            <Image src='/icons/lockicon.svg' width={0} height={0} className="h-[30px] w-[25px]" alt='account logo' />
          </div>
      ...
      <div className='flex flex-col gap-[24px] '>
        ...
        <div className="grid grid-cols-1 gap-[20px]">
          ...
          <input type='email' placeholder='Email Id' className="py-[8px] px-[16px] border-b border-customborderColor-300  focus:outline-none" required/>
          <input type='text' placeholder='Username' className=" py-[8px] px-[16px] border-b border-customborderColor-300 focus:outline-none"  required/>
          <input type='password' placeholder='Password' className=" py-[8px] px-[16px] border-b border-customborderColor-300 focus:outline-none" required />
          <input type='password' placeholder='Confirm Password' className=" py-[8px] px-[16px] border-b border-customborderColor-300 focus:outline-none"  required/> 
