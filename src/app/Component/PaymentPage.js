...
function PaymentPage({ onPrevious, onNext, onSetImage }) {
    ...
    return (
        ...
        <div className="w-full max-w-[1080px] border rounded-[24px] h-fit mt-[100px] mb-[10px] p-[20px] md:p-[30px] lg:p-[40px]  drop-shadow-[rgba(47, 115, 242, 0.15)  flex flex-col gap-[20px] bg-white">
            ...
            <div className='flex flex-col lg:gap-[24px] sm:gap-[20px] md:gap-[24px] gap-[12px]'>
                ...
                <div className='flex gap-[20px] flex-col'>
                    ...
                    <div className='flex flex-col md:flex-row md:flex-wrap   lg:flex-nowrap gap-4'>
                        <div className='rounded-[8px] py-[2px] md:py-[4px] lg:py-[4px] px-[0px] shadow-shadowMd bg-white flex justify-center w-full md:w-1/2  lg:w-1/4'>
                            <Image src='/icons/card.svg' width={208} height={72} className='rounded-[8px]' alt='card logo' />
                        </div>
                        <div className='rounded-[8px] py-[4px] px-[12px] md:py-[4px] lg:py-[4px] shadow-shadowMd bg-white flex justify-center w-full  md:flex-1 md:w-1/3  lg:w-1/4'>
                            <Image src='/icons/card (1).svg' width={208} height={72} className='rounded-[8px]' alt='card logo' />
                        </div>
                        <div className='rounded-[8px] py-[4px] px-[12px] md:py-[4px] lg:py-[4px] shadow-shadowMd bg-white flex justify-center w-full md:w-1/2  lg:w-1/4'>
                            <Image src='/icons/card(2).svg' width={208} height={72} className='rounded-[8px]' alt='card logo' />
                        </div>
                        <div className='rounded-[8px] p-[20px] md:py-[4px] lg:py-[4px] shadow-shadowMd bg-white w-full md:flex-1 flex justify-center items-center'>
                ...
                <div className='flex flex-col gap-[16px] sm:gap-[24px] md:gap-[24px] lg:gap-[24px]' >
                    ...
                    <div className=' flex flex-col gap-[4px] sm:gap-[8px] md:gap-[8px] lg:gap-[8px]'>
                        ...
                        <input type='text' placeholder='Name Of Card' className=' text-sm py-[4px] px-[6px] sm:py-[8px] sm:px-[12px] md:py-[8px] md:px-[12px] lg:py-[8px] lg:px-[12px] bg-white border-b border-customborderColor-300 focus:border-slate-500  focus:outline-none' required />
                    </div>
                    <div className='flex flex-col gap-[4px] sm:gap-[8px] md:gap-[8px] lg:gap-[8px]'>
                        <p className='font-sans font-medium text-base leading-[20px] text-tabTextColor '>
                            Card number
                        </p>
                        <input type='text' placeholder='Card number' className='text-sm py-[4px] px-[6px] sm:py-[8px] sm:px-[12px] md:py-[8px] md:px-[12px] lg:py-[8px] lg:px-[12px] bg-white border-b border-customborderColor-300  focus:border-slate-500 focus:outline-none ' required/>
                    </div>
                    <div className=' flex flex-col sm:flex-row md:flex-row lg:flex-row  gap-[16px] sm:gap-[24px] md:gap-[24px] lg:gap-[24px] '>
                        <div className=' flex flex-col  w-full  gap-[4px] sm:gap-[8px] md:gap-[8px] lg:gap-[8px]'>
                            ...
                            <input type='date' placeholder='mm/yy' className='text-sm py-[4px] px-[6px] sm:py-[8px] sm:px-[12px] md:py-[8px] md:px-[12px] lg:py-[8px] lg:px-[12px] bg-white border-b border-customborderColor-300 focus:border-slate-500  focus:outline-none' required/>
                        </div>
                        <div className='flex flex-col  w-full  gap-[4px] sm:gap-[8px] md:gap-[8px] lg:gap-[8px]'>
                            <p className=' font-sans font-medium text-base leading-[20px] text-tabTextColor '>
                                Cvv
                            </p>
                            <input type='text' placeholder='cvv' className='text-sm w-full py-[4px] px-[6px] sm:py-[8px] sm:px-[12px] md:py-[8px] md:px-[12px] lg:py-[8px] lg:px-[12px] bg-white border-b border-customborderColor-300 focus:border-slate-500  focus:outline-none' required/>
                        </div>
                    </div>
